...
{
   public class NoTransactionFeeState : State {
  public NoTransactionFeeState(Account account): base(account) {
  }

  public NoTransactionFeeState(State source): base(source) {
  }
